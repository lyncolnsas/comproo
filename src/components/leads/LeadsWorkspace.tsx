...
export default function LeadsWorkspace({
  ...
  return (
    <div className="space-y-6 animate-fade-in relative pb-12">
      {!hideHeader && (
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            onClick={fetchLeads}
            disabled={loading}
            className="text-xs font-bold py-2 px-3.5 rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-all shadow-xs flex items-center gap-2 cursor-pointer disabled:opacity-50"
      ...
      {/* Loading state */}
      {loading ? (
        <div className="flex h-[50vh] items-center justify-center bg-white rounded-2xl border border-slate-200/80 p-8 shadow-sm">
          <div className="flex flex-col items-center gap-3">
            <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-blue-600"></div>
            <p className="text-slate-500 text-xs font-semibold animate-pulse">Carregando inteligência de leads...</p>
          </div>
        </div>
      ) : error || !data ? (
        <div className="bg-rose-50 text-rose-700 p-6 rounded-2xl border border-rose-200 shadow-sm text-xs flex items-center gap-3">
          <span className="text-xl">⚠️</span>
          <div>
            <p className="font-bold text-rose-800">Falha ao Carregar Leads</p>
            <p className="text-[11px] text-rose-600 mt-0.5">{error || 'Não foi possível carregar os dados.'}</p>
          </div>
        </div>
      ) : (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-slate-500 text-[11px] font-bold uppercase tracking-wider">Total de Cadastros</h3>
              ...
              <div className="my-1 flex items-baseline justify-between">
                <span className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{data.total}</span>
              ...
              <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px]">
                ...
                <span className="text-slate-500 font-medium truncate max-w-[120px]" title={`${data.validWhatsAppPct}% com WhatsApp válido`}>
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-slate-500 text-[11px] font-bold uppercase tracking-wider">Cadastros Hoje</h3>
              ...
              <div className="my-1 flex items-baseline justify-between">
                <span className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{data.today}</span>
                <span className="text-xs text-emerald-600 font-bold">novos</span>
              </div>
              <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px]">
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-slate-500 text-[11px] font-bold uppercase tracking-wider">Conversão do Portal</h3>
              ...
              <div className="my-1 flex items-baseline justify-between">
                <span className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{data.conversionRate}%</span>
                <span className="text-xs text-amber-600 font-bold">efetividade</span>
              </div>
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-slate-500 text-[11px] font-bold uppercase tracking-wider">Recorrência</h3>
              ...
              <div className="my-1 flex items-baseline justify-between">
                <span className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{data.retentionRate}%</span>
                <span className="text-xs text-indigo-600 font-bold">retorno</span>
              </div>
              <div className="pt-2 border-t border-slate-100 text-[11px] text-slate-500 font-medium">
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-slate-500 text-[11px] font-bold uppercase tracking-wider">Tempo Médio</h3>
              ...
              <div className="my-1 flex items-baseline justify-between">
                <span className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">{data.avgSessionMinutes} min</span>
                <span className="text-xs text-purple-600 font-bold">duração</span>
              </div>
              <div className="pt-2 border-t border-slate-100 text-[11px] text-slate-500 font-medium">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-7 bg-white border border-slate-200/80 rounded-2xl p-6 shadow-xs flex flex-col">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                <div>
                  <h3 className="text-slate-900 text-xs font-bold uppercase tracking-wider">
                ...
                <div className="inline-flex p-1 bg-slate-100 rounded-xl">
                  <button
                    ...
                    className={`px-2.5 py-1 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                      timeTab === 'month' ? 'bg-white text-blue-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    Mês
                  </button>
                  <button
                    ...
                    className={`px-2.5 py-1 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                      timeTab === 'week' ? 'bg-white text-blue-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    Semana
                  </button>
                  <button
                    ...
                    className={`px-2.5 py-1 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                      timeTab === 'hour' ? 'bg-white text-blue-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    Dia / Horário
                  </button>
            ...
            <div className="lg:col-span-5 bg-white border border-slate-200/80 rounded-2xl p-6 shadow-xs flex flex-col">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 mt-0.5">Perfil dos leads capturados</p>
                </div>
                {/* Switcher selector */}
                <div className="inline-flex p-1 bg-slate-100 rounded-xl">
                  <button
                    ...
                    className={`px-2 py-1 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                      demoTab === 'age' ? 'bg-white text-blue-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    Idade
                  </button>
                  <button
                    ...
                    className={`px-2 py-1 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                      demoTab === 'gender' ? 'bg-white text-blue-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    Gênero
                  </button>
                  <button
                    ...
                    className={`px-2 py-1 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                      demoTab === 'device' ? 'bg-white text-blue-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    Dispositivo
                  </button>
              ...
              <div className="h-[210px] w-full relative flex items-center justify-center">
                {mounted && currentDemoChart.length > 0 ? (
                  ...
                  <p className="text-slate-400 text-xs italic">Dados insuficientes para visualização.</p>
                )}
              </div>

              {/* Badges list */}
              <div className="flex flex-wrap justify-center gap-2.5 mt-3 pt-3 border-t border-slate-100">
                {currentDemoChart.map((entry: any, index: number) => {
                  const isNeutral = entry.name.toLowerCase().includes('não informado') || entry.name.toLowerCase().includes('outros');
                  return (
                    <div key={index} className="flex items-center gap-1.5 text-[11px] text-slate-600 font-medium">
                      <span 
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs">
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-[11px] text-slate-500">Completude cadastral dos campos obrigatórios e complementares</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between text-xs font-semibold">
                  ...
                  <span className="text-emerald-700 font-bold">{data.dataQuality?.phonePct || 0}%</span>
                </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between text-xs font-semibold">
                  ...
                  <span className="text-blue-700 font-bold">{data.dataQuality?.emailPct || 0}%</span>
                </div>
                <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                  <div 
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between text-xs font-semibold">
                  ...
                  <span className="text-indigo-700 font-bold">{data.dataQuality?.cpfPct || 0}%</span>
                </div>
                <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                  <div 
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xs overflow-hidden">
            ...
            <div className="px-6 py-5 border-b border-slate-200 bg-white flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <div className="flex items-center gap-2.5">
                    <h3 className="text-slate-900 font-bold text-sm">Cadastros Recentes</h3>
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-blue-50 text-blue-700 border border-blue-200">
                      {filteredLeads.length} registros
                    </span>
                  </div>
                  <p className="text-xs text-slate-500 mt-0.5">Usuários capturados pelo portal captivo do hotspot</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto justify-start lg:justify-end">
                ...
                <div className="relative min-w-[200px] flex-1 sm:flex-initial">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-slate-400"
                  />
                </div>
                ...
                <select
                  ...
                  className="px-2.5 py-1.5 text-xs font-semibold bg-slate-50 border border-slate-200 rounded-xl text-slate-700 focus:outline-none cursor-pointer"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold border border-emerald-200 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 shadow-xs cursor-pointer transition-colors disabled:opacity-50"
                >
                  <svg className={`w-3.5 h-3.5 text-emerald-600 ${syncingAvatars ? 'animate-spin' : ''}`} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 shadow-xs cursor-pointer transition-colors"
                >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse min-w-[960px]">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">Usuário</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">WhatsApp</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">E-mail</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">CPF</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">Gênero</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">Nascimento</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">Senha</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">Campo Extra</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider whitespace-nowrap">Cadastrado</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-slate-600 uppercase tracking-wider text-center whitespace-nowrap">Ação</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 bg-white">
                  {paginatedLeads.length === 0 ? (
                    <tr>
                      <td colSpan={10} className="px-6 py-16 text-center">
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <p className="text-slate-500 text-xs font-semibold">Nenhum cadastro encontrado.</p>
                    ...
                    paginatedLeads.map((lead: any) => {
                      ...
                      let genderLabel = '';
                      let genderClass = 'bg-slate-50 text-slate-600 border-slate-200';
                      if (lead.gender === 'M') {
                        genderLabel = 'Masc';
                        genderClass = 'bg-blue-50 text-blue-700 border-blue-200';
                      } else if (lead.gender === 'F') {
                        genderLabel = 'Fem';
                        genderClass = 'bg-pink-50 text-pink-700 border-pink-200';
                      } else if (lead.gender === 'O') {
                        genderLabel = 'Outro';
                        genderClass = 'bg-purple-50 text-purple-700 border-purple-200';
                      }
                      ...
                      return (
                        <tr key={lead.id} className="hover:bg-slate-50/80 transition-colors">
                          ...
                          <td className="px-4 py-3 whitespace-nowrap">
                            {waLink ? (
                              <a
                                ...
                                className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold bg-emerald-50 text-emerald-700 hover:bg-emerald-100 border border-emerald-200 transition-colors"
                              >
                          ...
                          <td className="px-4 py-3 whitespace-nowrap">
                            {lead.email ? (
                              <span className="text-xs text-slate-700 font-medium">{lead.email}</span>
                            ) : (
                              <span className="text-xs text-slate-300 italic">—</span>
                            )}
                          </td>
                          ...
                          <td className="px-4 py-3 whitespace-nowrap">
                            {lead.cpf ? (
                              <span className="font-mono text-xs text-slate-700 font-medium">{lead.cpf}</span>
                            ) : (
                              <span className="text-xs text-slate-300 italic">—</span>
                            )}
                          </td>
                          ...
                          <td className="px-4 py-3 whitespace-nowrap">
                            {lead.password ? (
                              <span className="font-mono text-xs text-slate-700 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded-md">
                                {lead.password}
                              </span>
                            ) : (
                              <span className="text-xs text-slate-300 italic">—</span>
                          ...
                          <td className="px-4 py-3">
                            {lead.customFieldValue ? (
                              <span className="text-xs text-slate-600 font-medium truncate max-w-[130px] block" title={lead.customFieldValue}>
                                {lead.customFieldValue}
                              </span>
                            ) : (
                              <span className="text-xs text-slate-300 italic">—</span>
                          ...
                          <td className="px-4 py-3 text-center whitespace-nowrap">
                            <button
                              ...
                              className="w-8 h-8 inline-flex items-center justify-center rounded-xl text-rose-500 hover:text-rose-700 hover:bg-rose-50 border border-transparent hover:border-rose-200 disabled:opacity-40 cursor-pointer transition-colors"
                            >
            ...
            <div className="px-6 py-4 border-t border-slate-200 bg-slate-50 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1.5 mr-2">
                  <span className="text-[11px] text-slate-500 font-medium">Por página:</span>
                  <select
                    value={pageSize}
                    onChange={(e) => { setPageSize(Number(e.target.value)); setPage(1); }}
                    className="text-xs bg-white border border-slate-200 rounded-lg px-2 py-1 text-slate-700 font-bold focus:outline-none"
                  >
                ...
                <button
                  ...
                  disabled={page <= 1}
                  className="px-2.5 py-1 rounded-lg text-xs font-bold border border-slate-200 bg-white text-slate-700 hover:bg-slate-100 disabled:opacity-40 disabled:pointer-events-none transition-colors"
                >
                  Anterior
                </button>
